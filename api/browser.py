...
class Browser:
	def __init__(self, socks5=None, terminal=True, path_directory_browser=None):
		...
		print("Chromedriver PATH: ", chromeHelper.path);

		self.driver = webdriver.Chrome(chromeHelper.path, chrome_options=chrome_otions);
	...
	def registrar_evento(self, valor, script, tipo, callback):
